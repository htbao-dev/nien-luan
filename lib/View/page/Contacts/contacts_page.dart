...
import 'package:nien_luan/View/page/Contacts/contact_info_page.dart';
      ...
      child: ListTile(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => ContactInfoPage(index)));
        },
        title: Text(context
        ...
        leading: ContactAvatar(
          contact: context.watch<ContactProvider>().contacts!.elementAt(index),
          size: 50,
          fontSize: 20,
        ),
      ),
